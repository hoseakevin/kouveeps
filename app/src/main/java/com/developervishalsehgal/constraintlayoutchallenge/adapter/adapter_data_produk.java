...
import com.developervishalsehgal.constraintlayoutchallenge.MainActivity;
...
import com.developervishalsehgal.constraintlayoutchallenge.login;
 ...
 * Created by sab99r
 */
public class adapter_data_produk extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    * */
    ...
    public adapter_data_produk(Context context, List<Item> movies) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==TYPE_DATA){
            return new Data_produk_Holder(inflater.inflate(R.layout.list_produk,parent,false));
        }else{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(getItemViewType(position)==TYPE_DATA){
            ((Data_produk_Holder)holder).bindData(kampus.get(position));
        }
    ...
    static class Data_produk_Holder extends RecyclerView.ViewHolder {
                    ...
                    alertDialogBuilder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface arg0, int arg1) {
                                    ...
                                    mApiService.delete_produk(id_produk.getText().toString())
        ...
        void bindData(Item movieModel){
            id_produk.setText(movieModel.getID_PRODUK());
            nama_produk.setText(movieModel.getNAMA_PRODUK());
            harga.setText(movieModel.getHARGA());
            stok.setText(movieModel.getSTOCK());
