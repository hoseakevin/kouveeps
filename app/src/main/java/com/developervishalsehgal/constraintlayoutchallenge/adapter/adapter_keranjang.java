...
public class adapter_keranjang extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    * */
    ...
    public adapter_keranjang(Context context, List<Item> movies) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==TYPE_DATA){
            return new Data_produk_Holder(inflater.inflate(R.layout.list_keranjang,parent,false));
        }else{
    ...
    static class Data_produk_Holder extends RecyclerView.ViewHolder {
        TextView nama_barang,barang_beli,total,tanggal,id_transaksi;
        ...
        public Data_produk_Holder(View itemView) {
            ...
            barang_beli = (TextView) itemView.findViewById(R.id.barang_beli);
                    ...
                    alertDialogBuilder.setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface arg0, int arg1) {
                                    ...
                                    mApiService.delete_transaksi(id_transaksi.getText().toString())
        ...
        void bindData(Item movieModel){
            id_transaksi.setText(movieModel.getID_DETIL_TRANSAKSI_PRODUK());
            nama_barang.setText(movieModel.getNAMA_PRODUK());
            barang_beli.setText(movieModel.getJUMLAH_PRODUK());
            total.setText(movieModel.getSUB_TOTAL_PRODUK());
